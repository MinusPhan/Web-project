...
const inputUID = document.getElementById("IDADD2");
...
function AddItemsToTable1(UserID, Name, Mon, Tue, Wed, Thu, Fri, Sat, Sun) {
  ...
  if (Mon == "Late") {
    td3.style.backgroundColor = "rgb(152, 152, 0)";
    td3.style.color = "#fafafa"
  }
  if (Tue == "Late") {
    td4.style.backgroundColor = "rgb(152, 152, 0)";
    td4.style.color = "#fafafa"
  }
  if (Wed == "Late") {
    td5.style.backgroundColor = "rgb(152, 152, 0)";
    td5.style.color = "#fafafa"
  }
  if (Thu == "Late") {
    td6.style.backgroundColor = "rgb(152, 152, 0)";
    td6.style.color = "#fafafa"
  }
  if (Fri == "Late") {
    td7.style.backgroundColor = "rgb(152, 152, 0)";
    td7.style.color = "#fafafa"
  }
  if (Sat == "Late") {
    td8.style.backgroundColor = "rgb(152, 152, 0)";
    td8.style.color = "#fafafa"
  }
  if (Sun == "Late") {
    td9.style.backgroundColor = "rgb(152, 152, 0)";
    td9.style.color = "#fafafa"
  }
  if (Mon == "Timeout") {
    td3.style.backgroundColor = "rgb(152, 152, 0)";
...
//   Swal.fire({
//     title: 'Please choose the data you want to find!',
//     html: `
//       <div>
//         <input type="radio" id="option1" name="findOption" value="Day" style="float: left; clear: both; margin-right: 10px; margin-top: 3px">
//         <label for="option1" style="display: block; float: left;">1. Day</label>
//       </div>
//       <div>
//         <input type="radio" id="option2" name="findOption" value="UserID" style="float: left; clear: both; margin-right: 10px; margin-top: 3px">
//         <label for="option2" style="display: block; float: left;">2. UserID</label>
//       </div>
//       <div>
//         <input type="radio" id="option3" name="findOption" value="Status" style="float: left; clear: both; margin-right: 10px; margin-top: 3px">
//         <label for="option3" style="display: block; float: left;">3. Status</label>
//       </div>
//       <div>
//         <input type="radio" id="option4" name="findOption" value="Temp" style="float: left; clear: both; margin-right: 10px; margin-top: 3px">
//         <label for="option4" style="display: block; float: left;">4. Minimum temperature</label>
//       </div>
//     `,
//     inputAttributes: {
//       autocapitalize: 'off'
...
//     showLoaderOnConfirm: true,
//     preConfirm: () => {
//       const radios = document.getElementsByName('findOption');
//       let selectedValue;
//       for (const radio of radios) {
//         if (radio.checked) {
//           selectedValue = radio.value;
...
//         Swal.fire({
//           title: 'Please enter "DD-M" or "All',
//           input: 'text',
//           inputAttributes: {
//             autocapitalize: 'off'
//           },
...
Search.onmouseenter = function () {
  Search.style.backgroundColor = "#3A4F50";
  Search.style.color = "#0EF6CC";
}
...
Upload.onclick = function () {
  ...
  if (Addnew.style.display == "block") {
    ...
    if (New.UserID == "255") {
      ...
      inputUID.style.backgroundColor = "pink";
    }
    firebase.storage().ref(New.UserID).child().put(file)
  }
        ...
        return firebase.database().ref('Workspace').child(CurentRecord.key).orderByChild('Time').once('value')
          .then(function (AllRecords) {
            ...
            return Promise.all(records.map(function (CurentRecord) {
              ...
              var Status = CurentRecord.val().Status;
              var Temp = CurentRecord.val().Temp;
              return AddItemsToRealtime(Day, Time, userID, Status, Temp);
            }));
          });
      }));
    })
...
//-----------------------------------------------find data--------------------------------------------------------
// function findDate() {
//   var inputUID = document.getElementById("inputUID").value;
//   firebase.database().ref('Workspace').limitToFirst(rowCount).on('value', function (AllRecords) {
//     deleteAllRows('tbody2');
//     var records = [];
//     AllRecords.forEach(function (CurentRecord) {
//       if (CurentRecord.key === text) {
//         records.push(CurentRecord);
//       }
//     });
//     records.reverse();
...
//         var records = [];
//         AllRecords.forEach(function (CurentRecord) {
//           if (CurentRecord.val().UserID === inputUID) {
//             records.push(CurentRecord);
//           }
//         });
//         records.reverse();
