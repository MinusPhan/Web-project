...
Search.onclick = function () {
  Swal.fire({
    title: 'Please enter UserID you want to find!',
    input: 'text',
    inputAttributes: {
      autocapitalize: 'off'
    },
